...
bool BMP::WriteToFile( const wchar_t* FileName )
{
 using namespace std;
...
bool BMP::ReadFromFile( const wchar_t* FileName )
{ 
 using namespace std;
 if( !EasyBMPcheckDataSize() )
 {
...
BMFH GetBMFH( const wchar_t* szFileNameIn )
{
 using namespace std;
 BMFH bmfh;
...
BMIH GetBMIH( const wchar_t* szFileNameIn )
{
 using namespace std;
 BMFH bmfh;
 BMIH bmih;
...
int GetBitmapColorDepth( const wchar_t* szFileNameIn )
{
 BMIH bmih = GetBMIH( szFileNameIn );
